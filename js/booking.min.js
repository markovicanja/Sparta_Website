...
function reservePlace(date, time, exercise) {
    trening=exercise;
    datum=date.toString().slice(8,10)+'.'+(date.getMonth()+1)+'.'+(date.getYear()+1900);
    vreme=time.slice(0,5);
    termin=datum+'  '+vreme+' '+trening;

    alert(termin);

    countAdrian=localStorage.getItem("cntA");
    countJelica=localStorage.getItem("cntJ");
    ...
    localStorage.setItem('cntA', countAdrian);
    localStorage.setItem('cntJ', countJelica);
    localStorage.setItem(index, termin);
